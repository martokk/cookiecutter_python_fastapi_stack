...
class {{ cookiecutter.first_model | title }}CRUD(BaseCRUD[models.{{ cookiecutter.first_model | title }}, models.{{ cookiecutter.first_model | title }}Create, models.{{ cookiecutter.first_model | title }}Update]):
    async def create_with_owner_id(
        self, db: Session, *, in_obj: models.{{ cookiecutter.first_model | title }}Create, owner_id: str
    ) -> models.{{ cookiecutter.first_model | title }}:
        """
        ...
        Returns:
            models.{{ cookiecutter.first_model | title }}: The created {{ cookiecutter.first_model }}.
        """
    ...
    async def get_multi_by_owner_id(
    ...
    ) -> list[models.{{ cookiecutter.first_model | title }}]:
        """
        ...
        Returns:
            list[models.{{ cookiecutter.first_model | title }}]: A list of {{ cookiecutter.first_model }}s that match the given criteria.
        """
        return await self.get_multi(db=db, owner_id=owner_id, skip=skip, limit=limit)


{{ cookiecutter.first_model }} = {{ cookiecutter.first_model | title }}CRUD(models.{{ cookiecutter.first_model | title }})
