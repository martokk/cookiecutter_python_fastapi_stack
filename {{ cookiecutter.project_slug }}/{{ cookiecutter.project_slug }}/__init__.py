...
from {{ cookiecutter.project_slug }}.models.settings import Settings as _Settings
from {{ cookiecutter.project_slug }}.paths import ENV_FILE as _ENV_FILE
from {{ cookiecutter.project_slug }}.paths import LOG_FILE as _LOG_FILE
