...
from {{ cookiecutter.project_slug }} import get_version, settings
from {{ cookiecutter.project_slug }}.core.cli import version_callback
from {{ cookiecutter.project_slug }}.core.server import start_server


def test_version_callback(mocker: MagicMock) -> None:
    mock_console = mocker.patch("{{ cookiecutter.project_slug }}.core.cli.console")
