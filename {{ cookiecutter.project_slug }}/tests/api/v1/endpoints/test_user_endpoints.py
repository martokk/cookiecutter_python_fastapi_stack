...
@patch("{{ cookiecutter.project_slug }}.settings.SMTP_PORT", 1025)
@patch("{{ cookiecutter.project_slug }}.settings.SMTP_HOST", "example.com")
@patch("{{ cookiecutter.project_slug }}.settings.EMAILS_FROM_EMAIL", "test@example.com")
async def test_create_user(
    ...
    with patch("{{ cookiecutter.project_slug }}.core.notify.send_new_account_email") as mock:
        r = client.post(
