...
async def test_reset_password(db_with_user: Session, client: TestClient) -> None:
    ...
    with patch("{{ cookiecutter.project_slug }}.core.notify.send_reset_password_email") as mock_send_email:
        r = client.post(
...
async def test_reset_password_with_invalid_user_id_from_token(
    ...
    """
    with patch("{{ cookiecutter.project_slug }}.core.security.decode_token") as mock_decode_token:
...
async def test_get_current_user_not_found(
    ...
    """
    with patch("{{ cookiecutter.project_slug }}.core.security.decode_token") as mock_get_current_user_id:
...
async def test_get_current_active_user_inactive_user(
    ...
    with patch("{{ cookiecutter.project_slug }}.api.deps.get_current_user_id") as mock_get_current_user_id:
